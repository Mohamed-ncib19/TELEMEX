...
<?php }else{ ?>
  ...
  <?php } ?>
    ...
    <iconify-icon id="navClosed" icon="uil:bars" class="text-[3rem]" ></iconify-icon>

    <iconify-icon id="navOpen" class="hidden text-[3rem] " icon="ic:round-close"></iconify-icon>
    ...
    <div id="container-sidebar" class=" relative z-40">
        <nav id="sidebar"
            ...
            <div id="sidenavbar" class="bg-[#2B2E86] h-full w-full flex justify-center items-start ">
                ...
                <?php if (isset($_SESSION['login_user'])) { ?>
                  <li class=" flex items-center before:ease relative h-auto  overflow-hidden  text-[1.3rem]  transition-all before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700 hover:before:-translate-x-40 duration-500 w-full">
      <?php if ($_SESSION['type'] == 'admin') { ?> 
        <a class="" href="mainindex.php" >
      ...
      <a class="  w-full " href="profile.php" >
        ...
        <p class=""><?php echo $_SESSION['prenom'] ." ".  $_SESSION['login_user']; ?></p>
          ...
          <li class=" flex flex-row justify-start items-center  before:ease relative h-auto text-[1.3rem] overflow-hidden   text-white  transition-all before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700 hover:before:-translate-x-40 duration-500 w-full">
          ...
          <?php if (isset($_SESSION['login_user'])) { ?>
          <li class="flex flex-row justify-start items-center text-[1.3rem] before:ease relative h-auto overflow-hidden   text-white  transition-all before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700 hover:before:-translate-x-40 duration-500 w-full">
