...
<div id="default-carousel" class="relative w-full h-screen  overflow-hidden" data-carousel="slide">
    ...
    <div class="relative w-full h-full overflow-hidden  ">
          ...
          <div class="flex flex-col justify-center items-center gap-7  h-full   ">
            <h1 class="z-30 text-[#E1E1E1] md:text-[2rem] text-[1.5rem] font-sans tracking-wider" >Suivi de votre expédition</h1>
            <div class=" z-30 md:w-[35%] w-[80%] flex flex-row justify-center items-center bg-gray-400 rounded-full relative ">
                ...
                <input type="number" placeholder="Saisissez votre numéro de suivi" class="w-full bg-gray-200 shadow-inner rounded-full p-4 text-purple-800 after:font-extrabold border-gray-300 focus:ring-2 focus:ring-purple-500  transition-all duration-500"  required>
            </div>
            <p class="z-30 text-[#E1E1E1] font-light tracking-wide " >Plusieurs numéros de suivi Besoin d'aide ?</p>
            <button  type="submit" id="loginButton" class="  z-30 bg-red-600 p-3 px-8 flex flex-row justify-center items-center  gap-4 rounded-full before:ease relative shadow-lg overflow-hidden transition-all before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700 hover:before:-translate-x-40 duration-500" >
...
<!--"A propos" Section-->
<div class="bg-[#F6F6F6] flex md:flex-row flex-col md:justify-between">
    <div id="content" class="flex flex-col justify-center items-start">
        <div class="md:w-[70%] flex flex-col md:justify-start justify-center max-md:text-center max-md:items-center gap-6 mx-5 rounded-3xl p-2 animate__animated" id="animatedContent">
            <h1 class="text-[2rem] text-[#E3514B]">À PROPOS</h1>
            <p class="tracking-wider leading-9">
    ...
    <div>
        <img src="./newdesign/images/design/Apropos.png" class="md:block hidden animate__animated animate__fadeIn" alt="TELEMEX">
    </div>
</div>
...
<div class="flex md:flex-row flex-col gap-8 text-center mt-5" >
...
<h1 class="text-[#2B2E86] text-[1.3rem] font-semibold" >Prise de commande
 en temps réel</h1>
 <p class="text-[#505050] font-normal w-[60%] leading-7" >Grâce à Telemex, commandez en temps réel pour une réactivité optimale.</p>
  </div>
...
<h1 class="text-[#2B2E86] text-[1.3rem] font-semibold">Simulation instantanée des prix</h1>
<p class="text-[#505050] font-normal w-[60%] leading-7">Obtenez des tarifs instantanés avec la simulation des prix offerte par Telemex.</p>
  </div>
...
<div class="bg-[#F6F6F6] p-8 space-y-12" >
  <h1 class="text-center text-[#2B2E86] text-[2rem]" >Nos services de <span class="text-[#E92C24]" > livraison</span></h1>
  <div class="flex md:flex-row flex-col justify-center items-center gap-8 " >

  <div class=" border-b-4 border-red-600 bg-[#FFFFFF] hover:scale-105 hover:shadow-xl md:w-[30%] w-[80%] p-3 flex flex-col justify-center items-center gap-4 transition-all duration-700 animate__animated " id="animatedService"  >
    <svg xmlns="http://www.w3.org/2000/svg" width="70" height="51" viewBox="0 0 50 51" fill="none">
    ...
    <h1 class="text-[#2B2E86] text-[1.3rem] font-semibold" >Repas et Boissons</h1>
    <p  class="text-[#505050] font-normal w-[80%] leading-7 text-center " >Commandez vos repas et contactez-nous pour assurer la livraison. Que vous soyez à la maison ou au bureau.</p>
  </div>

  <div class=" border-b-4 border-red-600 bg-[#FFFFFF] hover:scale-105 hover:shadow-xl md:w-[30%] w-[80%] p-3 flex flex-col justify-center items-center gap-4 transition-all duration-700 animate__animated " id="animatedService2">
    ...
    <h1 class="text-[#2B2E86] text-[1.3rem] font-semibold" >Colis et Courrier</h1>
    <p class="text-[#505050] font-normal w-[80%] leading-7 text-center ">Confiez-nous vos livraisons, gagnez du temps et de l'argent, concentrez-vous sur votre activité.</p>
  </div>

  <div class=" border-b-4 border-red-600 bg-[#FFFFFF] hover:scale-105 hover:shadow-xl md:w-[30%] w-[80%] p-3 flex flex-col justify-center items-center gap-4 transition-all duration-700 animate__animated " id="animatedService3">
    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="51" viewBox="0 0 50 51" fill="none">
    ...
    <h1 class="text-[#2B2E86] text-[1.3rem] font-semibold" >Espace stockage</h1>
    <p class="text-[#505050] font-normal w-[60%] leading-7 text-center ">Nous offrons un stockage sécurisé pour les marchandises des e-commerçants.</p>
  </div>
...
<div class="bg-[#F6F6F6/[.3] max-h-max flex flex-col justify-around gap-12 p-8 mt-5" >
  <h1 class="text-center text-[2rem] text-[#2B2E86]" > <span class="text-[#E92C24]" > Comment </span> ça marche ?</h1>
  ...
  <div class="flex lg:flex-row flex-col justify-between items-center  gap-1" >
    ...
    <div id="step1" class="  flex flex-col justify-center items-center gap-4 animate__animated  "  >
      ...
      <h1 class="text-[1.5rem]" >TÉLÉCHARGER</h1>
      <p class=" text-center text-[1rem]  font-normal tracking-widest" >Visitez notre <span class="text-[#2B2E86]" > site web</span> ou téléchargez <span class="text-[#E92C24]" > l'application mobile</span></p>
    </div>
    <iconify-icon icon="bi:arrow-right" class="text-[3.5rem] md:block hidden text-[#2B2E86] animate__animated" id="animatedArrow"  ></iconify-icon>
    <iconify-icon icon="solar:arrow-down-outline" class="md:hidden block text-[5rem] text-[#2B2E86]"></iconify-icon>
    ...
    <div id="step2" class="  flex flex-col justify-center items-center gap-2 animate__animated "  >
      ...
      <h1 class="text-[1.5rem] " >Connectez-vous</h1>
      <p class=" text-center font-normal tracking-widest" >Connectez-vous, saisissez les détails et adresses, puis cliquez sur "Valider"</p>
    </div>
    <iconify-icon icon="bi:arrow-right" class="text-[3.5rem] md:block hidden text-[#2B2E86] animate__animated" id="animatedArrow2"  ></iconify-icon>
    <iconify-icon icon="solar:arrow-down-outline" class="md:hidden block text-[5rem] text-[#2B2E86]"></iconify-icon>
    ...
    <div id="step3" class="  flex flex-col justify-center items-center gap-2 animate__animated"  >
      ...
      <h1 class="text-[1.5rem]" >Commander</h1>
      <p class=" text-center font-normal tracking-widest" >Après validation de votre commande, recevez un lien de suivi par SMS pour suivre votre colis en temps réel.</span></p>
    </div>
    <iconify-icon icon="bi:arrow-right" class="text-[3.5rem] md:block hidden text-[#2B2E86] animate__animated" id="animatedArrow3"  ></iconify-icon>
    <iconify-icon icon="solar:arrow-down-outline" class="md:hidden block text-[5rem] text-[#2B2E86]"></iconify-icon>
    ...
    <div id="step4" class="  flex flex-col justify-center items-center gap-2 animate__animated"  >
      ...
      <h1 class="text-[1.5rem]" >réceptionner</h1>
      <p class=" text-center font-normal tracking-widest" >Attribuez une note à votre coursier après la livraison pour finaliser l'opération.</span></p>
    </div>
...
<div class="bg-[#F6F6F6] flex flex-col justify-center items-center gap-12 p-7" >
  <h1 class="text-[#2B2E86] md:text-[2rem] text-[1.7rem]" >Pourquoi nous <span class="text-[#E92C24]" >choisir</span> ?</h1>
  <div class="flex md:flex-row flex-col gap-12 justify-center items-center" >

  <div class=" border-b-4 border-red-600 bg-[#FFFFFF] hover:scale-105 hover:shadow-xl md:w-[30%] w-[80%] p-3 flex flex-col justify-center items-center gap-4 transition-all duration-700 animate__animated " id="why-us-1"  >
...
<path d="M21.857 24.8809C19.4548 24.3263 16.9584 24.3219 14.5544 24.868C12.1503 25.4141 9.90079 26.4966 7.97399 28.0345C6.0472 29.5725 4.49298 31.5261 3.42754 33.7493C2.36209 35.9724 1.81298 38.4077 1.82126 40.873V46.3373H21.857M38.8691 49.8709C38.4689 50.0156 38.0307 50.0156 37.6305 49.8709C34.5925 48.6673 31.9857 46.5795 30.1476 43.8776C28.3096 41.1758 27.325 37.9844 27.3213 34.7166V29.9445C27.3052 29.7011 27.3412 29.4571 27.4271 29.2288C27.5129 29.0005 27.6465 28.7932 27.819 28.6208C27.9915 28.4483 28.1988 28.3147 28.4271 28.2288C28.6553 28.143 28.8993 28.1069 29.1427 28.123H47.357C47.6003 28.1069 47.8443 28.143 48.0726 28.2288C48.3009 28.3147 48.5082 28.4483 48.6807 28.6208C48.8531 28.7932 48.9867 29.0005 49.0726 29.2288C49.1584 29.4571 49.1945 29.7011 49.1784 29.9445V34.7166C49.1747 37.9844 48.1901 41.1758 46.352 43.8776C44.514 46.5795 41.9072 48.6673 38.8691 49.8709Z" stroke="#FF0000" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <h1 class="text-[#E92C24] text-[1.3rem] font-semibold" >SÉCURITÉ</h1>
    <p  class="text-[#505050] font-normal w-[80%] leading-7 text-center " >Chez TELEMEX, tous les coursiers sont professionnels et identifiés, avec suivi en temps réel.</p>
  </div>

  <div class=" border-b-4 border-red-600 bg-[#FFFFFF] hover:scale-105 hover:shadow-xl md:w-[30%] w-[80%] p-3 flex flex-col justify-center items-center gap-4 transition-all duration-700 animate__animated " id="why-us-2"  >
...
<rect width="51" height="51" fill="white"/>
    ...
    <h1 class="text-[#E92C24] text-[1.3rem] font-semibold" >FLEXIBILITÉ</h1>
    <p  class="text-[#505050] font-normal w-[80%] leading-7 text-center " >Commandez facilement depuis chez vous ou votre bureau grâce à TELEMEX, sur ordinateur, smartphone ou tablette</p>
  </div>

  <div class=" border-b-4 border-red-600 bg-[#FFFFFF] hover:scale-105 hover:shadow-xl md:w-[30%] w-[80%] h-[31vh] p-3 flex flex-col justify-center items-center gap-4 transition-all duration-700 animate__animated " id="why-us-3"  >
  <svg xmlns="http://www.w3.org/2000/svg" width="51" height="51" viewBox="0 0 51 51" fill="none">
<path d="M4.51718 23.8241L46.41 4.772M46.41 4.772L38.5779 1.82129M46.41 4.772L43.4957 12.6041M48.2679 49.2149H39.1607V23.7149C39.1607 23.2318 39.3526 22.7685 39.6942 22.4269C40.0358 22.0853 40.4991 21.8934 40.9822 21.8934H46.4465C46.9295 21.8934 47.3928 22.0853 47.7344 22.4269C48.076 22.7685 48.2679 23.2318 48.2679 23.7149V49.2149ZM30.0536 49.2149H20.9465V29.1791C20.9465 28.6961 21.1384 28.2328 21.4799 27.8912C21.8215 27.5496 22.2848 27.3577 22.7679 27.3577H28.2322C28.7152 27.3577 29.1785 27.5496 29.5201 27.8912C29.8617 28.2328 30.0536 28.6961 30.0536 29.1791V49.2149ZM11.8393 49.2149H2.73218V34.6434C2.73218 34.1604 2.92408 33.6971 3.26566 33.3555C3.60725 33.0139 4.07053 32.822 4.55361 32.822H10.0179C10.501 32.822 10.9643 33.0139 11.3058 33.3555C11.6474 33.6971 11.8393 34.1604 11.8393 34.6434V49.2149Z" stroke="#FF0000" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <h1 class="text-[#E92C24] text-[1.3rem] text-center font-semibold" >BOOSTEZ VOTRE PERFORMANCE</h1>
    <p  class="text-[#505050] font-normal w-[80%] leading-7 text-center ">Concentrez-vous sur votre activité et confiez la livraison de vos colis à TELEMEX</p>
  </div>
...
<div>
  <h1 class="text-center text-[2rem] text-[#2B2E86]  mt-8" >ILS PARLENT DE NOUS</h1>
<div id="indicators-carousel" class="relative w-full" data-carousel="slide">
    <!-- Carousel wrapper -->
    <div class="relative h-[70%] overflow-hidden rounded-lg mt-16">
         <!-- Item 1 -->
        <div class="hidden duration-700 ease-in-out m-auto " data-carousel-item="active">

            <div class="md:w-[40%] m-auto bg-[#2B2E86]/[.3]   shadow-lg max-h-max md:p-6 p-4 mt-5" >
              <div class="flex flex-row gap-4 justify-start items-center p-3" >
              <iconify-icon icon="mingcute:user-4-line" class="text-white text-[4rem]" ></iconify-icon>
              <div class="flex flex-col gap-1 font-semibold" >
                <h1 class="text-red-600 text-[1.5rem] " >nom entreprise</h1>
                <div class="flex flex-row" >
                <iconify-icon icon="ic:outline-star" class=" text-yellow-400 text-[1.5rem]"  ></iconify-icon>
                <iconify-icon icon="ic:outline-star" class=" text-yellow-400 text-[1.5rem]" ></iconify-icon>
                <iconify-icon icon="ic:outline-star" class=" text-yellow-400 text-[1.5rem]" ></iconify-icon>
                <iconify-icon icon="ic:outline-star" class=" text-yellow-400 text-[1.5rem]" ></iconify-icon>
                <iconify-icon icon="ic:outline-star" class=" text-yellow-400 text-[1.5rem]" ></iconify-icon>
        ...
        <div class="md:w-[40%] m-auto bg-[#2B2E86]/[.3]   shadow-lg max-h-max md:p-6 p-4 mt-5" >
              ...
              <div class="flex flex-col gap-1" >
                <h1 class="text-red-600 text-[1.5rem] font-semibold " >nom entreprise</h1>
                <div class="flex flex-row" >
                <iconify-icon icon="ic:outline-star" class=" text-yellow-400 text-[1.5rem]"  ></iconify-icon>
                <iconify-icon icon="ic:outline-star" class=" text-yellow-400 text-[1.5rem]" ></iconify-icon>
                <iconify-icon icon="ic:outline-star" class=" text-yellow-400 text-[1.5rem]" ></iconify-icon>
              ...
              <p class="px-8 md:leading-7 font-normal" >J’ai découvert Telemex par le biais d’une amie qui me l’a recommandé. Moi J’effectue régulièrement mes vente en ligne étant très occupée j’ai souvent du mal à faire à livrer moi-même. Je les ai contacté la première fois en leur fournissant toutes les infos. En un laps de temps l’opération s’est faite. J’ai été très Surprise de la rapidité et le professionnalisme de leur coursier. Dorénavant je ne me tracasserai plus je sais que j’ai la solution.</p>
            </div>
            </div>
        <!-- Item 3 -->
        <div class="hidden duration-700 ease-in-out " data-carousel-item="active">
        <div class="md:w-[40%] m-auto bg-[#2B2E86]/[.3]   shadow-lg max-h-max md:p-6 p-4 mt-5" >
              ...
              <p class="px-8 md:leading-7 font-normal " >Notre restaurant est réputé comme l’un des meilleurs dans la ville de Douala. Depuis que nous avons découvert TELEMEX nous n’avons plus de problèmes de livraison avec nos clients. Leur disponibilité et rapidité nous permet de satisfaire nos clients. Merci TELEMEX</p>
            </div>
            </div>
    ...
    <button type="button" class="absolute top-0 start-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
        <span class="inline-flex items-center justify-center bg-red-200 hover:bg-gray-50  shadow-md w-10 h-10 rounded-full  focus:ring-2 focus:ring-purple-500">
            <svg class="w-4 h-4 text-red-600 hover:text-purple-500 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
...
<div class="bg-[#F6F6F6]/[.8] mt-16 flex md:flex-row flex-col justify-around items-center gap-5 p-1 " >
  <h1 class="text-[2rem] text-[#2B2E86] p-8 animate__animated " id="downloadContent" >Expédiez vos colis via notre <span class="text-[#E92C24]" >app mobile</span></h1>
  <img src="./newdesign/images/group8.svg" id="appImage" class="md:w-[30%] animate__animated " alt="TELEMEX APP">
</div>
</div>
<script>
    // Get the element to animate
...
<div class="p-4 mt-8 flex flex-col gap-6 " >
  <h1 class="text-[2rem] text-center text-[#2B2E86]" >ILS NOUS FONT <span class="text-[#E92C24]" > CONFIANCE</span></h1>
...
<div id="controls-carousel" class="relative w-full" data-carousel="slide">
    ...
    <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
        ...
        <div class="flex justify-center items-center duration-700 ease-in-out bg-[#D9D9D9]/[.3] rounded-lg " data-carousel-item>
            <img src="./newdesign/images/design/1.png" class="md:w-[30%] w-[50%] m-auto" alt="...">
        </div>
        <!-- Item 2 -->
        <div class="flex justify-center items-center duration-700 ease-in-out bg-[#D9D9D9]/[.3] rounded-lg " data-carousel-item>
            <img src="./newdesign/images/design/2.png" class="md:w-[30%] w-[50%] m-auto" alt="...">
        </div>
        <!-- Item 3 -->
        <div class="flex justify-center items-center duration-700 ease-in-out bg-[#D9D9D9]/[.3] rounded-lg " data-carousel-item>
            <img src="./newdesign/images/design/3.png" class="md:w-[30%] w-[50%] m-auto" alt="...">
        </div>
        <!-- Item 4 -->
        <div class="flex justify-center items-center duration-700 ease-in-out bg-[#D9D9D9]/[.3] rounded-lg " data-carousel-item>
            <img src="./newdesign/images/design/4.png" class="md:w-[30%] w-[50%] m-auto" alt="...">
        </div>
        <!-- Item 5 -->
        <div class="flex justify-center items-center duration-700 ease-in-out bg-[#D9D9D9]/[.3] rounded-lg " data-carousel-item>
            <img src="./newdesign/images/design/5.png" class="md:w-[30%] w-[50%] m-auto" alt="...">
        </div>
    </div>
    <!-- Slider controls -->
    <button type="button" class="absolute top-0 start-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
        <span class="inline-flex items-center justify-center w-10 h-10 rounded-full group-focus:outline-none">
            <svg class="w-4 h-4 text-[#2B2E86] rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 1 1 5l4 4"/>
            </svg>
            <span class="sr-only">Previous</span>
        </span>
...
<div class="flex flex-col  items-center bg-[#D9D9D9]/[.5] mt-8 p-4" >
  <h2 class="text-center text-[2.5rem] text-[#2B2E86] font-normal" >Nos performances</h2>
  <div class="flex md:flex-row flex-col justify-around items-center  w-full" >
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="90" height="90" viewBox="0 0 50 45" fill="none">
...
<p  class="text-[#E92C24] text-[1.8rem] font-semibold"  >+5000</p>
<p class="text-[#000000]/[.8] font-semibold text-[1.5rem]" >Colis livrés</p>
    </div>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="90" height="90" viewBox="0 0 47 44" fill="none">
...
<p class="text-[#E92C24] text-[1.8rem] font-semibold" >+200</p>
<p class="text-[#000000]/[.8] font-semibold text-[1.5rem]" >Clients satisfaits</p>
    </div>
